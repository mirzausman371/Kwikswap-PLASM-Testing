    ...
    <HeaderFrame>
      ...
      <HeaderRow>
        ...
        <HeaderLinks>
          ...
          <StyledExternalLocalLink style={{display: 'block !important'}}  id={`stake-nav-link`} href={'https://home.kwikswap.org'}>
            Buy KWIK <span style={{ fontSize: '11px' }}></span>
          </StyledExternalLocalLink>
          <StyledNavVoteLink id={`stake-nav-link`} to={'/votepage'}>
            Vote
          </StyledNavVoteLink>
