...
describe('utils', () => {
  ...
  describe('#isAddress', () => {
    ...
    it('returns the checksummed address', () => {
      expect(isAddress('0xEC8413897e056a7ee79Ab5bDacc116c27b8fF4ec')).toBe('0xEC8413897e056a7ee79Ab5bDacc116c27b8fF4ec')
      expect(isAddress('0xEC8413897e056a7ee79Ab5bDacc116c27b8fF4ec')).toBe('0xEC8413897e056a7ee79Ab5bDacc116c27b8fF4ec')
    })

    it('succeeds even without prefix', () => {
      expect(isAddress('EC8413897e056a7ee79Ab5bDacc116c27b8fF4ec')).toBe('0xEC8413897e056a7ee79Ab5bDacc116c27b8fF4ec')
    })
    it('fails if too long', () => {
      expect(isAddress('EC8413897e056a7ee79Ab5bDacc116c27b8fF4ec0')).toBe(false)
    })
  })
  ...
  describe('#shortenAddress', () => {
    ...
    it('truncates middle characters', () => {
      expect(shortenAddress('0xEC8413897e056a7ee79Ab5bDacc116c27b8fF4ec')).toBe('0xEC84...F4ec')
    })

    it('truncates middle characters even without prefix', () => {
      expect(shortenAddress('EC8413897e056a7ee79Ab5bDacc116c27b8fF4ec')).toBe('0xEC84...F4ec')
    })
